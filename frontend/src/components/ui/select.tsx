...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // ░░ COLOR FIXES ONLY — MATCH INPUT ░░
        "!bg-surface dark:!bg-surface",                   // same surface background
        "!placeholder:text-muted-foreground",             // match input placeholder
        "[&_svg]:text-muted-foreground",                  // match icon tone

        // ░░ ORIGINAL SHADCN STYLES (unchanged) ░░
        "cursor-pointer border-input data-[placeholder]:text-muted-foreground",
        "[&_svg:not([class*='text-'])]:text-muted-foreground",
        "focus-visible:border-ring focus-visible:ring-ring/50",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        "dark:bg-input/30 dark:hover:bg-input/50",
        "flex w-full items-center justify-between gap-2 rounded-md border bg-background px-3 py-2",
